...
- [x] Add live `terrain_landform_profile_tour.tscn` review scene that cycles `balanced_current`, `strong_mountains`, and `compressed_scale` on representative sites through the normal walk/far terrain stack.
